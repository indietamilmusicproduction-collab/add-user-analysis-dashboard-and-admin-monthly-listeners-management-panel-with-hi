    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {/* Artwork Upload */}
          <div>
            <Label htmlFor="admin-edit-artwork">
          ...
          {/* Music Video Link */}
          <div>
            <Label htmlFor="admin-edit-musicVideoLink">
          ...
          {/* Additional Details */}
          <div>
            <Label htmlFor="admin-edit-additionalDetails">
          ...
          {/* Discount Code */}
          <div>
            <Label htmlFor="admin-edit-discountCode">
